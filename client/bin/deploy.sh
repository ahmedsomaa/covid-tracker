...
echo $VITE_AUT0_READ_API_SCOPE | vercel env add VITE_AUT0_READ_API_SCOPE production --token=$VERCEL_TOKEN
echo $VITE_AUTH0_UPDATE_API_SCOPE | vercel env add VITE_AUTH0_UPDATE_API_SCOPE production --token=$VERCEL_TOKEN
